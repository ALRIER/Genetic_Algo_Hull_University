...
# =============================================================================
# This file is intentionally separate from the discovery pipeline. The original
# GA code remains untouched. This layer reads completed discovery outputs, selects
# a focused set of regimes, and re-evaluates fixed GA winners against an expanded
# benchmark set under additional independent validation seeds.
# =============================================================================

FIXED_WEIGHT_VALIDATION_CONFIG <- list(
  # Paths. Set PROJECT_ROOT to the folder containing 00_utils_debug_io.R ...
  # 10_distributional_diagnostics.R. Set DISCOVERY_ROOT to the folder containing the final
  ...
  # Final validation budget. These values define the production validation run.
  monte_carlo_R = 500L,
  bootstrap_B = 500L,
