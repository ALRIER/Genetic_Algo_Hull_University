...
admissible_estimator_mask <- function(distribution = NULL,
  ...
  # Harmonic and geometric means are blocked when the distribution family can
  # generate zero or negative values. Target compatibility is recorded in
  # metadata; stronger target penalties belong to the fitness layer.
  mask <- rep(TRUE, N_EST)
